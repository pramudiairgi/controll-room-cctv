...
class CctvFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'category' => $this->faker->randomElement(array_values(App\Enums\AssetCategory::cases()))->value,
            ...
            'status' => $this->faker->randomElement(array_values(App\Enums\CctvStatus::cases()))->value,
